...
const Lowerer = struct {
    ...
    const FnBodyWorkspace = struct {
        ...
        fn init(allocator: std.mem.Allocator) FnBodyWorkspace {
            return .{
                ...
                .tail_call_scratch = lir_core.TailCallBuilder.init(allocator, @enumFromInt(0)),
    ...
    fn finish(self: *Lowerer) Output {
        ...
        self.tail_call_scratch = lir_core.TailCallBuilder.init(self.allocator, @enumFromInt(0));
